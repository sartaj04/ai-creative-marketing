...
Given a topic, template, and context, determine the optimal post length range.
...
- Otherwise: Optimize for the TOPIC.
...
class LengthStrategistService:
    ...
    async def determine_optimal_length(
        ...
        try:
            ...
            logger.info(
                ...
                f"(template: {template_category}, flexibility: {template_flexibility})"
            )
            ...
            if not response or not isinstance(response, dict):
                ...
                return self._get_fallback_length(template_category, template_min, template_max)
    ...
    def _get_fallback_length(
        ...
        # Category-based fallbacks with slight randomization
        category_lengths = {
            "myth_buster": (250, 400),
            "tips": (200, 300),
            "story": (250, 450),
        ...
        return {
            ...
            "reasoning": f"Fallback length for {template_category or 'general'} content",
